...
public class ViewAllOnCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_all_on_category);
...
//        Toast.makeText(this, value, Toast.LENGTH_SHORT).show();
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    adapter = new PostAdapter(modelCLassList, ViewAllOnCategory.this);
    ...
    public void onBackPressed() {
        Intent intent= new Intent(ViewAllOnCategory.this,ViewPostActivity.class);
