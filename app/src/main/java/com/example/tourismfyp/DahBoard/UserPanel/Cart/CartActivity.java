...
public class CartActivity extends AppCompatActivity {
    ...
    ArrayList<CartModelClass> modelCLassList=new ArrayList<>();
   public CartModelClass modelCLass;
   public String LoginUserFirstName,LoginUserLastName;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot d : snapshot.getChildren()) {
                        ...
                        modelCLass = new CartModelClass(bookinguserfirstname, bookinguserlastname, bookinguseremail, category, cnic, currentdate, desc,perhead, latitude, longitude, phoneNumber, url, title, lastDate, city, item, owner, status, id);

                    modelCLassList.add(modelCLass);
                    }
                    adapter = new CartAdapter(modelCLassList, CartActivity.this,LoginUserEmail,LoginUserFirstName,LoginUserLastName);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(CartActivity.this, UserPanel.class);
        startActivity(intent);
        finish();
