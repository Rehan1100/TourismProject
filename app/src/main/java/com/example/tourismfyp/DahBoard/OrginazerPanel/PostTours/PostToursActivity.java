...
public class PostToursActivity extends AppCompatActivity implements OnMapReadyCallback {
    Toolbar toolbar;
    NavigationView nav;
    ImageView camera;
    ...
    String Categoriy="PostTour";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_post_tours);
        ...
        mapFragment.getMapAsync(PostToursActivity.this);
        ...
        Date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final DatePickerDialog datePickerDialog = new DatePickerDialog(PostToursActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        if (getday > Startday && getmonth> Startmonth && getyear > StartYear) {
                            ...
                            Date.setText("");
                            Toast.makeText(PostToursActivity.this, "You're Selecting the Previous date", Toast.LENGTH_SHORT).show();
                        } else if (getday == Startday && getmonth== Startmonth && getyear == StartYear) {
                            Date.setText("");
                            Toast.makeText(PostToursActivity.this, "You're Selecting the current date", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            try {
               imageURI = data.getData();
                ...
                e.printStackTrace();
                Toast.makeText(PostToursActivity.this, "Something went wrong", Toast.LENGTH_LONG).show();
            }

        }else {
            Toast.makeText(PostToursActivity.this, "You haven't picked Image",Toast.LENGTH_LONG).show();
        }
    }
      ...
      private void uploadPDFile() {
          ...
          final ProgressDialog progressDialog = new ProgressDialog(PostToursActivity.this);
          ...
          reference.putFile(imageURI)
                  .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                      ...
                      public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                          ...
                          UploadRecord uploadrecord = new UploadRecord(title.getText().toString(), url.toString(), desc.getText().toString(), item, id,DeadlineDate,saveCurrentDate,LoginUserEmail,Phonenumber.getText().toString(),cnic.getText().toString(),Perhead.getText().toString(),longitude,latiude,Categoriy,Date.getText().toString(),city.getText().toString());
                          databaseReference.child(databaseReference.push().getKey()).setValue(uploadrecord);
                          Toast.makeText(PostToursActivity.this, "uploading", Toast.LENGTH_SHORT).show();
              ...
              public void onFailure(@NonNull Exception e) {
                  ...
                  Toast.makeText(PostToursActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
              }
          });
      }
    ...
    public void onBackPressed() {
        Intent intent= new Intent(PostToursActivity.this,OrganizerPanel.class);
        startActivity(intent);
        finish();
